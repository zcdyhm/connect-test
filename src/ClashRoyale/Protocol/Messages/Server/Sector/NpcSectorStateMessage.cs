...
namespace ClashRoyale.Protocol.Messages.Server
{
    public class NpcSectorStateMessage : PiranhaMessage
    {
        ...
        public override void Encode()
        {
            ...
            Writer.WriteVInt(12);
            Writer.WriteVInt(13);
            Writer.WriteVInt(16500); // X
            Writer.WriteVInt(29500); // Y
            Writer.WriteHex("00007F00C07C0002000000000000");

            // Enemy Left Princess Tower
            Writer.WriteVInt(12);
            Writer.WriteVInt(13);
            Writer.WriteVInt(1500); // X
            Writer.WriteVInt(2500); // Y
            ...
            Writer.WriteVInt(0); // Ms before regen mana
            Writer.WriteVInt(9); // Elexir Start Enemy
            Writer.WriteVInt(0);
            Writer.WriteVInt(0);
            Writer.WriteVInt(0);
            ...
            Writer.WriteVInt(8777); // Enemy 
            Writer.WriteVInt(0);
            Writer.WriteVInt(8777); // Player
            Writer.WriteVInt(0);
            Writer.WriteVInt(8777); // Enemy
            Writer.WriteVInt(0);
            Writer.WriteVInt(8777); // Player
            Writer.WriteVInt(0);
            Writer.WriteVInt(15552); // Enemy
            Writer.WriteVInt(0);
            Writer.WriteVInt(15552); // Player
            Writer.WriteVInt(0);
