...
namespace ClashRoyale.Core.Leaderboards
{
    public class Leaderboard
    {
        ...
        public List<Alliance> GlobalAllianceRanking = new List<Alliance>(50);
        public List<Player> GlobalPlayerRanking = new List<Player>(100);
        ...
        public Leaderboard()
        {
            ...
            foreach (var locales in Csv.Tables.Get(Csv.Files.Locales).GetDatas())
                LocalPlayerRanking.Add(((Locales) locales).Name, new List<Player>(100));
